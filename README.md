...
> <p align="center"><b>会出题的 AI 教练</b><br>懂你哪里不会。在你遗忘之前提醒你。<br>以千年儒学为体，以学习科学为用。</p>
...
刷过题的同学都知道——题库 App 来来去去就那几百道题。**题目背下来 ≠ 学会了。**考试换一种问法，你还是不会。
...
欢迎的方向：🧪 新科目 Prompt 模板 · 🎨 UI/UX · 🧠 掌握度算法 · 📸 **截图（急需！）** · 📖 文档
